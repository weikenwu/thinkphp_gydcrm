...
<table>
    <tr><th>操作</th><th>用户名</th><th>姓名</th><th>最后登录时间</th></tr>    
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
<td><a href="?act=edit&id=<?php echo ($vo["op_id"]); ?>">[编辑]</a> 
    <?php if($super < 1 ): else: ?>
    <a href="?act=del&id=<?php echo ($vo["op_id"]); ?>" onclick="return todel()">[删除]</a><?php endif; ?>
</td>
<td><a href="__ROOT__/admin.php/User/change/user/<?php echo ($vo["username"]); ?>"><?php echo ($vo["username"]); ?></a></td>
<td><?php echo ($vo["name"]); ?></td>
<td><span style="color:gray">[ <?php echo (date('Y-m-d H:i:s',$vo["lastlogin"])); ?> ]</span></td>
