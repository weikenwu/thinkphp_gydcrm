...
<form action="?act=save" method="post" class="tableform" id="x-op-info-form">
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input type="hidden" value="<?php echo ($vo["op_id"]); ?>" name="op_id">
...
<input type="hidden" value="1" name="__"><?php endforeach; endif; else: echo "" ;endif; ?>
</form>
    </body>