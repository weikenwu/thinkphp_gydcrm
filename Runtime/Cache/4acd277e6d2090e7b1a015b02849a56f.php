...
<table>
  ...
  <tr>
    <td class="func">
<a target="_blank" class="sysiconBtn" href="__ROOT__/admin.php/Kehu/getorderinfocsv">订单导出</span>
	</td>
    <td></td>
  </tr>
</tbody></table>
...
<form action="__ROOT__/admin.php/Kehu/find" class="finder-filter finder-filter-pos" id="finder-filter-c0b5c6" view="" method="post" style="position: absolute; top: 45px; left: 400px; z-index: 10;" action="">
...
<table cellpadding="0" cellspacing="0" id="center">
    <tr><th>操作</th><th>平台</th><th>加入时间</th><th>姓名</th><th>手机</th><th>邮箱</th><th>地址</th><th>销售总额</th></tr>    
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
<td width="60"><input type="checkbox" value="" name="opid" /><a href="#">[查看]</a></td>
<td width="100"><?php echo ($vo["terminal_name"]); ?></td>
<td width="120"><span style="color:gray"><?php echo (date('Y-m-d H:i:s',$vo["first_time"])); ?></span></td>
<td width="60"><?php echo ($vo["ship_name"]); ?></td>
<td width="80"><?php echo ($vo["ship_mobile"]); ?></td>
<td width="100"><?php echo ($vo["ship_email"]); ?></td>
<td width="450"><?php echo ($vo["ship_addr"]); ?></td>
<td width="60"><?php echo (number_format($vo["accumulate"], 2, '.', '')); ?></td>
